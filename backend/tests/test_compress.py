...
def test_compress_image(client: 'FlaskClient', temp_image: str):
...
def test_compress_with_different_formats(client: 'FlaskClient', temp_image: str):
...
def test_compress_invalid_image(client: 'FlaskClient'):
