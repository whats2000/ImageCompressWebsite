...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Handle Download Type DropDownList
    handleDownloadTypeDDL();
...
function handleDownloadTypeDDL() {
    // Custom Select Menu for Download Type
    const downloadTypeSelectMenu = document.getElementById("downloadType");
    const selectBtn = downloadTypeSelectMenu.querySelector(".select-btn");
    const sBtnText = selectBtn.querySelector(".sBtn-text");
    const options = downloadTypeSelectMenu.querySelectorAll(".option");

    selectBtn.addEventListener("click", () => {
        downloadTypeSelectMenu.classList.toggle("active");
    });
    ...
    options.forEach((option) => {
        option.addEventListener("click", () => {
            ...
            downloadTypeSelectMenu.dataset.value = option.getAttribute("data-value");

            downloadTypeSelectMenu.classList.remove("active");
        });
    });
}
